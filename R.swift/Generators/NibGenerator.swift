...
struct NibGenerator: Generator {
  ...
  private static func nibVarForNib(nib: Nib) -> Var {
    ...
    let structType = Type(module: nil, name: "_R.nib.\(nibStructName)")
  ...
  private static func nibStructForNib(nib: Nib) -> (usedModules: Set<Module>, nibStruct: Struct) {
    ...
    let instantiateParameters = [
      ...
      Function.Parameter(name: "options", localName: "optionsOrNil", type: Type(module: nil, name: "[NSObject : AnyObject]", optional: true))
    ]
    ...
    let instantiateFunc = Function(
      ...
      returnType: Type(module: nil, name: "[AnyObject]"),
    ...
    if let reusable = nib.reusables.first where nib.rootViews.count == 1 && nib.reusables.count == 1 {
      ...
      reuseTypealiasses = [Typealias(alias: Type(module: nil, name: "ReusableType"), type: reusable.type)]
    ...
    return (
      usedModules,
      Struct(
        type: Type(module: nil, name: "_\(sanitizedName)"),
